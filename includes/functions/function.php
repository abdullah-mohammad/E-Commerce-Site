<?php
    ...
    */
    ...
    /*
    ** Get short text function v 1.0
    ** get short text from long text
    ** $text : the text 
    ** $lang : number the charckter 
    */

    function getShortText($text,$lang = 50){
        
        if (strlen($text) > $lang) 
            return substr($text, 0, strrpos(substr($text, 0, $lang), " ")).'...';
        else return $text;
    }